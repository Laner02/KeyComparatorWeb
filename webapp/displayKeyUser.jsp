...
<html lang="es">
    ...
    <body>
    	<%
    		//display de Key solo para cuando el usuario esta registrado
    		...
    		session.removeAttribute("currentKey");		//Eliminamos el atributo para poder volver a usar el nombre
    		//tambien guardamos el nombre del usuario
