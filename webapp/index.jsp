...
<html lang="es">
    <head>
        ...
        <title>KeyComparator - Encuentra los mejores juegos al mejor precio</title>
    </head>
    <body>
        ...
        <div id="menuLateral" class="sidenav">
            <!--Los # son las URL a las que te llevan los link, deberan ser los de las paginas que hagamos, pero desde esta si que si le das al perfil te lleva al perfil del usuario-->
            <a href="#top" class="active"><img class="sidenavPhoto" src="./imgs/hotKeys.png" alt="Tendencia"></a>
            <a href="offer.jsp"><img class="sidenavPhoto" src="./imgs/offer.png" alt="Ofertas"></a>
            <a href="topReview.jsp"><img class="sidenavPhoto" src="./imgs/topValorados.png" alt="TopValor"></a>
            <a href="newKeys.jsp"><img class="sidenavPhoto" src="./imgs/nuevo.png" alt="Nuevos"></a>
        </div>
