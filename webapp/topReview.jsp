...
<html lang="es">
    <head>
        ...
        <title>KeyComparator - Los mejor valorados</title>
    </head>
    <body>
        ...
        <div id="menuLateral" class="sidenav">
            ...
            <a href="index.jsp"><img class="sidenavPhoto" src="./imgs/hotKeys.png" alt="Tendencia"></a>
            <a href="offer.jsp"><img class="sidenavPhoto" src="./imgs/offer.png" alt="Ofertas"></a>
            <a href="#top" class="active"><img class="sidenavPhoto" src="./imgs/topValorados.png" alt="TopValor"></a>
